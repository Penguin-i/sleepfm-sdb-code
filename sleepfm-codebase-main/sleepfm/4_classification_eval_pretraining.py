...
def main(args):
    ...
    # 保存测试标签，供高级指标计算使用
    logger.info(f"Saving test labels...")
    with open(os.path.join(path_to_probs, f"test_labels.pickle"), 'wb') as file:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="logistic", choices=["logistic", "xgb", "rf"], help="Type of model")
